...
APEX_DATA.pickrate = {
  seasonNo: 30,
  label:   "シーズン30 開幕3日目 / 全ランク帯・全モード",
  updated: "2026-08-07",
  source:  "apexlegendsstatus.com",
  sample:  "約3,400万プレイヤー",
  legends: [
    ["Bloodhound","ブラッドハウンド",10.6,621.63,"#e0453f"],
    ["Axle","アクセル",9.5,-23.57,"#c44dff"],
    ["Loba","ローバ",9.3,579.98,"#d95ac2"],
    ["Pathfinder","パスファインダー",8.2,-2.19,"#6ec8ff"],
    ["Mad Maggie","マッドマギー",6.6,-10.27,"#ff2d78"],
    ["Octane","オクタン",5.9,-8.77,"#6fdd3a"],
    ["Wraith","レイス",5.3,-0.15,"#8a5cff"],
    ["Bangalore","バンガロール",4.8,-11.73,"#93a06a"],
    ["Fuse","ヒューズ",4.1,-9.75,"#ff6a1f"],
    ["Lifeline","ライフライン",3.3,-14.48,"#3ad6b0"],
    ["Valkyrie","ヴァルキリー",2.9,-56.46,"#5f6bd8"],
    ["Gibraltar","ジブラルタル",2.6,3.71,"#3b8fd6"],
    ["Alter","オルター",2.4,-31.76,"#b06bff"],
    ["Conduit","コンジット",2.4,-34.37,"#ff7ad9"],
    ["Ash","アッシュ",2.3,-12.79,"#b03a8f"],
    ["Seer","シア",2.1,-40.61,"#d0a02a"],
    ["Rampart","ランパート",2.1,101.05,"#3fd3c8"],
    ["Caustic","コースティック",2.0,-26.16,"#b6d442"],
    ["Mirage","ミラージュ",2.0,-19.55,"#ffc93d"],
    ["Revenant","レヴナント",2.0,-12.91,"#c02a45"],
    ["Sparrow","スパロウ",1.9,-34.62,"#e0603a"],
    ["Wattson","ワットソン",1.9,-19.83,"#ffe14d"],
    ["Horizon","ホライゾン",1.6,8.73,"#9fe8ff"],
    ["Vantage","ヴァンテージ",1.4,-28.12,"#a8d8f0"],
    ["Ballistic","バリスティック",1.0,3.46,"#c8a04a"],
    ["Newcastle","ニューキャッスル",0.8,-36.21,"#2f6fff"],
    ["Catalyst","カタリスト",0.6,-17.27,"#6a4dd6"],
    ["Crypto","クリプト",0.5,-38.18,"#39c46a"]
  ]
};
