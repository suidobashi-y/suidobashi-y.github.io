...
APEX_DATA.pickrate = {
  seasonNo: 30,
  label:   "シーズン30 開幕30日目 / 全ランク帯・全モード",
  updated: "2026-09-03",
  source:  "apexlegendsstatus.com",
  sample:  "約3,440万プレイヤー",
  legends: [
    ["Pathfinder","パスファインダー",10.2,2.93,"#6ec8ff"],
    ["Loba","ローバ",8.4,-7.74,"#d95ac2"],
    ["Axle","アクセル",8.1,-15.43,"#c44dff"],
    ["Mad Maggie","マッドマギー",7.1,-2.81,"#ff2d78"],
    ["Fuse","ヒューズ",6.5,10.10,"#ff6a1f"],
    ["Octane","オクタン",5.9,4.49,"#6fdd3a"],
    ["Wraith","レイス",5.3,0.80,"#8a5cff"],
    ["Bangalore","バンガロール",4.6,2.72,"#93a06a"],
    ["Alter","オルター",3.8,18.01,"#b06bff"],
    ["Lifeline","ライフライン",3.3,3.79,"#3ad6b0"],
    ["Caustic","コースティック",3.2,7.16,"#b6d442"],
    ["Sparrow","スパロウ",3.1,6.63,"#e0603a"],
    ["Valkyrie","ヴァルキリー",3.1,-1.99,"#5f6bd8"],
    ["Seer","シア",2.9,-9.60,"#d0a02a"],
    ["Bloodhound","ブラッドハウンド",2.7,0.61,"#e0453f"],
    ["Ash","アッシュ",2.5,9.51,"#b03a8f"],
    ["Gibraltar","ジブラルタル",2.5,-9.54,"#3b8fd6"],
    ["Conduit","コンジット",2.3,2.41,"#ff7ad9"],
    ["Wattson","ワットソン",2.3,1.39,"#ffe14d"],
    ["Vantage","ヴァンテージ",2.2,4.11,"#a8d8f0"],
    ["Mirage","ミラージュ",1.9,3.85,"#ffc93d"],
    ["Revenant","レヴナント",1.8,0.26,"#c02a45"],
    ["Horizon","ホライゾン",1.4,2.62,"#9fe8ff"],
    ["Rampart","ランパート",1.4,-5.66,"#3fd3c8"],
    ["Newcastle","ニューキャッスル",1.0,1.07,"#2f6fff"],
    ["Catalyst","カタリスト",0.9,14.59,"#6a4dd6"],
    ["Crypto","クリプト",0.8,6.92,"#39c46a"],
    ["Ballistic","バリスティック",0.7,-3.35,"#c8a04a"]
  ]
};
