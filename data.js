...
APEX_DATA.pickrate = {
  seasonNo: 30,
  label:   "シーズン30 開幕4日目 / 全ランク帯・全モード",
  updated: "2026-08-08",
  source:  "apexlegendsstatus.com",
  sample:  "約3,410万プレイヤー",
  legends: [
    ["Bloodhound","ブラッドハウンド",9.7,537.40,"#e0453f"],
    ["Loba","ローバ",9.4,575.45,"#d95ac2"],
    ["Axle","アクセル",9.2,-26.43,"#c44dff"],
    ["Pathfinder","パスファインダー",8.4,0.81,"#6ec8ff"],
    ["Mad Maggie","マッドマギー",6.7,-9.19,"#ff2d78"],
    ["Octane","オクタン",5.8,-10.22,"#6fdd3a"],
    ["Wraith","レイス",5.2,0.33,"#8a5cff"],
    ["Bangalore","バンガロール",4.9,-11.08,"#93a06a"],
    ["Fuse","ヒューズ",4.4,-3.46,"#ff6a1f"],
    ["Lifeline","ライフライン",3.4,-11.21,"#3ad6b0"],
    ["Valkyrie","ヴァルキリー",3.0,-55.24,"#5f6bd8"],
    ["Gibraltar","ジブラルタル",2.7,3.50,"#3b8fd6"],
    ["Alter","オルター",2.5,-25.89,"#b06bff"],
    ["Conduit","コンジット",2.3,-33.36,"#ff7ad9"],
    ["Ash","アッシュ",2.3,-12.98,"#b03a8f"],
    ["Seer","シア",2.3,-36.04,"#d0a02a"],
    ["Caustic","コースティック",2.2,-22.72,"#b6d442"],
    ["Rampart","ランパート",2.1,98.63,"#3fd3c8"],
    ["Sparrow","スパロウ",2.0,-30.84,"#e0603a"],
    ["Mirage","ミラージュ",2.0,-21.63,"#ffc93d"],
    ["Revenant","レヴナント",1.9,-16.47,"#c02a45"],
    ["Wattson","ワットソン",1.8,-20.68,"#ffe14d"],
    ["Vantage","ヴァンテージ",1.5,-26.00,"#a8d8f0"],
    ["Horizon","ホライゾン",1.4,-2.21,"#9fe8ff"],
    ["Ballistic","バリスティック",1.0,5.32,"#c8a04a"],
    ["Newcastle","ニューキャッスル",0.8,-31.63,"#2f6fff"],
    ["Catalyst","カタリスト",0.6,-15.45,"#6a4dd6"],
    ["Crypto","クリプト",0.5,-34.08,"#39c46a"]
  ]
};
