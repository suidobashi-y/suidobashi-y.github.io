...
var APEX_DATA = {
  ...
  /* ランク分布：上位ティアから順に記述
     ...
     ★グラフからの読み取り値です。プラチナIII(16.122) / ゴールドIV(9.417) / ダイヤIV(5.212) は
       ツールチップ実測値です。合計が100%になるよう正規化しています。
       ※正規化の端数はシルバーIVで吸収しています */
  rank: {
    seasonNo: 30,   // この分布データのシーズン。現在のシーズンと違うと注意書きが出ます
    label:   "シーズン30 スプリット2 / ランクマッチ（スプリット2開始6日目）",
    updated: "2026-09-21",
    dayFromStart: 48,   // シーズン開幕からの日数（スプリット2は9/16開始で6日目）
    source:  "apexlegendsstatus.com",
    divEstimated: false,
    inProgress: true,   // シーズン進行中のスナップショット（上位帯がまだ埋まっていない）
    tiers: [
      {n:"プレデター",   s:"PRED", c:"pred",   pct: 0.31},
      {n:"マスター",     s:"MAS",  c:"master", pct: 0.15},
      {n:"ダイヤモンド", s:"DIA",  c:"dia",    pct:11.21, div:[0.83, 1.35, 3.82, 5.21]},
      {n:"プラチナ",     s:"PLA",  c:"plat",   pct:44.14, div:[7.14, 10.67, 16.12, 10.21]},
      {n:"ゴールド",     s:"GLD",  c:"gold",   pct:20.39, div:[2.16, 3.26, 5.55, 9.42]},
      {n:"シルバー",     s:"SIL",  c:"silver", pct:13.72, div:[1.72, 2.29, 3.31, 6.40]},
      {n:"ブロンズ",     s:"BRZ",  c:"bronze", pct: 8.62, div:[1.43, 1.38, 1.51, 4.30]},
      {n:"ルーキー",     s:"RKY",  c:"rookie", pct: 1.46, div:[0.41, 0.07, 0.10, 0.88]}
    ]
  },
...
APEX_DATA.pickrate = {
  seasonNo: 30,
  label:   "シーズン30 開幕52日目（スプリット2開始10日目） / 全ランク帯・全モード",
  updated: "2026-09-25",
  source:  "apexlegendsstatus.com",
  sample:  "約3,460万プレイヤー",
  legends: [
    ["Pathfinder","パスファインダー",10.9,5.62,"#6ec8ff"],
    ["Axle","アクセル",10.6,8.73,"#c44dff"],
    ["Loba","ローバ",7.6,10.06,"#d95ac2"],
    ["Mad Maggie","マッドマギー",6.2,9.63,"#ff2d78"],
    ["Octane","オクタン",6.0,-0.95,"#6fdd3a"],
    ["Fuse","ヒューズ",5.6,-25.40,"#ff6a1f"],
    ["Wraith","レイス",4.9,-2.90,"#8a5cff"],
    ["Bangalore","バンガロール",4.5,6.31,"#93a06a"],
    ["Conduit","コンジット",4.2,-21.43,"#ff7ad9"],
    ["Lifeline","ライフライン",3.4,7.88,"#3ad6b0"],
    ["Sparrow","スパロウ",3.4,4.37,"#e0603a"],
    ["Valkyrie","ヴァルキリー",2.8,-3.32,"#5f6bd8"],
    ["Catalyst","カタリスト",2.7,-22.39,"#6a4dd6"],
    ["Vantage","ヴァンテージ",2.6,18.58,"#a8d8f0"],
    ["Alter","オルター",2.6,-4.19,"#b06bff"],
    ["Seer","シア",2.5,6.03,"#d0a02a"],
    ["Revenant","レヴナント",2.4,-6.43,"#c02a45"],
    ["Ash","アッシュ",2.3,0.30,"#b03a8f"],
    ["Caustic","コースティック",2.2,-2.62,"#b6d442"],
    ["Gibraltar","ジブラルタル",2.1,15.04,"#3b8fd6"],
    ["Bloodhound","ブラッドハウンド",2.0,-11.68,"#e0453f"],
    ["Mirage","ミラージュ",2.0,12.92,"#ffc93d"],
    ["Wattson","ワットソン",1.9,13.27,"#ffe14d"],
    ["Horizon","ホライゾン",1.3,-3.08,"#9fe8ff"],
    ["Rampart","ランパート",1.2,3.92,"#3fd3c8"],
    ["Newcastle","ニューキャッスル",0.8,7.64,"#2f6fff"],
    ["Crypto","クリプト",0.7,8.50,"#39c46a"],
    ["Ballistic","バリスティック",0.6,-0.08,"#c8a04a"]
  ]
};
