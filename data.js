...
var APEX_DATA = {
  ...
  rank: {
    ...
    tiers: [
      {n:"プレデター",   s:"PRED", c:"pred",   pct: 0.44},
      {n:"マスター",     s:"MAS",  c:"master", pct: 1.84},
      {n:"ダイヤモンド", s:"DIA",  c:"dia",    pct:27.99, div:[2.40, 5.27, 11.35, 8.97]},
      {n:"プラチナ",     s:"PLA",  c:"plat",   pct:25.63, div:[6.36, 6.54, 7.27, 5.46]},
      {n:"ゴールド",     s:"GLD",  c:"gold",   pct:20.16, div:[4.77, 5.18, 5.62, 4.59]},
      {n:"シルバー",     s:"SIL",  c:"silver", pct:13.96, div:[3.39, 3.66, 3.81, 3.10]},
      {n:"ブロンズ",     s:"BRZ",  c:"bronze", pct: 8.64, div:[2.54, 2.16, 1.96, 1.98]},
      {n:"ルーキー",     s:"RKY",  c:"rookie", pct: 1.34, div:[0.37, 0.07, 0.09, 0.81]}
    ]
  },
