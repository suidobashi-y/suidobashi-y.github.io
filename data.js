...
var APEX_DATA = {
  ...
  rank: {
    ...
    tiers: [
      {n:"プレデター",   s:"PRED", c:"pred",   pct: 0.43},
      {n:"マスター",     s:"MAS",  c:"master", pct: 1.36},
      {n:"ダイヤモンド", s:"DIA",  c:"dia",    pct:24.47, div:[1.72, 4.38, 9.88, 8.49]},
      {n:"プラチナ",     s:"PLA",  c:"plat",   pct:29.14, div:[7.31, 7.73, 8.31, 5.79]},
      {n:"ゴールド",     s:"GLD",  c:"gold",   pct:20.99, div:[5.04, 5.21, 5.90, 4.84]},
      {n:"シルバー",     s:"SIL",  c:"silver", pct:14.01, div:[3.44, 3.61, 3.77, 3.19]},
      {n:"ブロンズ",     s:"BRZ",  c:"bronze", pct: 8.31, div:[2.50, 2.10, 1.79, 1.92]},
      {n:"ルーキー",     s:"RKY",  c:"rookie", pct: 1.29, div:[0.34, 0.06, 0.08, 0.81]}
    ]
  },
