...
var APEX_DATA = {
  ...
  rank: {
    ...
    tiers: [
      {n:"プレデター",   s:"PRED", c:"pred",   pct: 0.42},
      {n:"マスター",     s:"MAS",  c:"master", pct: 0.93},
      {n:"ダイヤモンド", s:"DIA",  c:"dia",    pct:19.75, div:[1.06, 2.78, 8.14, 7.77]},
      {n:"プラチナ",     s:"PLA",  c:"plat",   pct:30.75, div:[7.17, 7.89, 9.05, 6.64]},
      {n:"ゴールド",     s:"GLD",  c:"gold",   pct:24.44, div:[6.16, 6.46, 6.56, 5.26]},
      {n:"シルバー",     s:"SIL",  c:"silver", pct:14.36, div:[3.64, 3.73, 3.81, 3.18]},
      {n:"ブロンズ",     s:"BRZ",  c:"bronze", pct: 8.10, div:[2.34, 2.05, 1.81, 1.90]},
      {n:"ルーキー",     s:"RKY",  c:"rookie", pct: 1.25, div:[0.35, 0.05, 0.07, 0.78]}
    ]
  },
